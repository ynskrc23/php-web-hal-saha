...
<head>
  ...
  <script src="css/akullanıcı/jquery.min.js"></script>
  <script src="css/akullanıcı/popper.min.js"></script>
  <script src="css/akullanıcı/bootstrap.min.js"></script>
	<style> 
input[type=ara] {
    width: 40%;
...
<div class="container">
  ...
  <h2 style="text-align:center;">Kullanıcı Güncelleme Formu</h2>
	...
	<?php 
		do { $ID=$goster['ID']; ?> 
			<tr>
				...
				<th><a href='kyenile.php?guncel=<?php echo $ID; ?>'> Güncelle</a></th>
