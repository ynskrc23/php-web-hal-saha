...
<head>
  ...
  <script src="css/afikgor/jquery.min.js"></script>
  <script src="css/afikgor/popper.min.js"></script>
  <script src="css/afikgor/bootstrap.min.js"></script>
	<style> 
input[type=ara] {
    width: 40%;
...
<div class="container">
  ...
  <h2 style="text-align:center;">Fikstür Görüntüleme Formu</h2>
  <br></br>
