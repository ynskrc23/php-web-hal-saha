...
<head>
  ...
  <script src="css/fikstur/jquery.min.js"></script>
  <script src="css/fikstur/popper.min.js"></script>
  <script src="css/fikstur/bootstrap.min.js"></script>
	<style> 
input[type=ara] {
    width: 40%;
...
<div class="container">
  ...
  <h2 style="text-align:center;">Fikstürüm</h2>
  <br></br>
  ...
  <table class="table table-bordered">
	...
	$baglan=mysqli_connect("94.73.144.27","u7764842_userBAB","KAplan.42");
		mysqli_select_db($baglan,"u7764842_dbBAB");
			...
			$bul="Select * from fikstur where takim1 IN(Select Takim from kisiler where Email='".$email."') ";		
			$deger= mysqli_query($baglan,$bul);
			$goster=mysqli_fetch_array($deger) ;
			 
			 $bul2="Select * from fikstur where takim2 IN(Select Takim from kisiler where Email='".$email."' ) ";		
	...
	<?php } 
		...
		do { ?> 
			<tr>
				<th><?php echo $goster2["takim1"]?></th>
				<th><?php echo $goster2["t1skor"]?></th>
				<th><?php echo $goster2["t2skor"]?></th>
				<th> <?php echo $goster2["takim2"]?></th>
			</tr>
