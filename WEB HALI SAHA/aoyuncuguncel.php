...
<head>
  ...
  <script src="css/aoguncel/jquery.min.js"></script>
  <script src="css/aoguncel/popper.min.js"></script>
  <script src="css/aoguncel/bootstrap.min.js"></script>
	<style> 
input[type=ara] {
    width: 40%;
...
<div class="container">
  ...
  <h2 style="text-align:center;">Takım Oyuncularını Güncelleme Formu</h2>
	...
	<?php 
		do { $ID=$goster['ID']; ?> 
			<tr>
				...
				<th><a href='yenile.php?guncel=<?php echo $ID; ?>'> Güncelle</a></th>
