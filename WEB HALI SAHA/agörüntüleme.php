...
<head>
  ...
  <script src="css/agor/jquery.min.js"></script>
  <script src="css/agor/popper.min.js"></script>
  <script src="css/agor/bootstrap.min.js"></script>
	<style> 
input[type=ara] {
    width: 40%;
  ...
  <table class="table table-bordered">
    <thead>
      <tr>
		...
		<th bgcolor="yellow">Dogum Tarihi</th>
	...
	<?php 
		do { ?> 
			<tr>
				...
				<th><?php echo $goster["Adres"]?></th>
				<th><?php echo $goster["DogumTarihi"]?></th>
