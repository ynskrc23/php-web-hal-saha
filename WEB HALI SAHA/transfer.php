...
<head>
  ...
  <script src="css/transfer/jquery.min.js"></script>
  <script src="css/transfer/popper.min.js"></script>
  <script src="css/transfer/bootstrap.min.js"></script>
	<style> 
input[type=ara] {
    width: 40%;
	...
	<?php 
		do { $ID=$goster['ID']; ?> 
			<tr>
				...
				<th><a href='teklif.php?teklif=<?php echo $ID; ?>'> Teklif Yap</a></th>
			</tr>
