...
<head>
  ...
  <script src="css/atransfer/jquery.min.js"></script>
  <script src="css/atransfer/popper.min.js"></script>
  <script src="css/atransfer/bootstrap.min.js"></script>
	<style> 
input[type=ara] {
    width: 40%;
...
<div class="container">
  ...
  <h2 style="text-align:center;">Transfer İşlemleri</h2>
  <br></br>
 <form method="post">
  ...
  <table class="table table-bordered">
    <thead>
      <tr>
		...
		<th bgcolor="yellow">Teklif Yapan</th>
		...
		do { $ID=$goster['email'];
		   ...
		   ?>
			<tr> 
				...
				<th><?php echo $goster["teklifyapan"]?></th>	
				<th><a href='tyenile.php?kabul=<?php echo $ID; ?>'> Kabul Et</a></th>
				<th><a href='tred.php?red=<?php echo $ID; ?>'> Reddet</a></th>
			</tr>
