...
<head>
  ...
  <script src="css/guncel/jquery.min.js"></script>
  <script src="css/guncel/popper.min.js"></script>
  <script src="css/guncel/bootstrap.min.js"></script>
	<style>
	.bg-4 { 
...
{ 
	...
	$Takim=$_POST["takim"];
	$Mevki=$_POST["mevki"];	
	$sql="insert into kisiler (isim,Soyisim,Adres,DogumTarihi,Email,Takim,Mevki) values ('".$isim."','".$Soyisim."','".$Adres."','".$DogumTarihi."','".$Email."','".$Takim."','".$Mevki."')";
...
<div class="container" >
	...
	<h4 style="text-align:center;">Lütfen İlgili Alanları Doldurunuz...</h4><br>
	</br>
  ...
  <form method="post" >
	...
	<div class="form-group">
		...
		<input type="takım" class="form-control" name="takim" placeholder="Hangi Takımın Oyuncususun?">
    </div>
